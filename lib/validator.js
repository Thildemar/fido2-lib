...
function validateExpectations() {
  return _validateExpectations.apply(this, arguments);
}

function _validateExpectations() {
  _validateExpectations = _asyncToGenerator(function* () {
...
function validateRawClientDataJson() {
  return _validateRawClientDataJson.apply(this, arguments);
}

function _validateRawClientDataJson() {
  _validateRawClientDataJson = _asyncToGenerator(function* () {
...
function _validateId() {
  _validateId = _asyncToGenerator(function* () {
...
function validateOrigin() {
  return _validateOrigin.apply(this, arguments);
}

function _validateOrigin() {
  _validateOrigin = _asyncToGenerator(function* () {
...
function validateCreateType() {
  return _validateCreateType.apply(this, arguments);
}

function _validateCreateType() {
  _validateCreateType = _asyncToGenerator(function* () {
...
function validateGetType() {
  return _validateGetType.apply(this, arguments);
}

function _validateGetType() {
  _validateGetType = _asyncToGenerator(function* () {
    var type = this.clientData.get("type");
...
function validateChallenge() {
  return _validateChallenge.apply(this, arguments);
}

function _validateChallenge() {
  _validateChallenge = _asyncToGenerator(function* () {
    ...
    challenge = challenge.replace(/={1,2}$/, ""); // console.log("challenge", challenge);
...
function validateTokenBinding() {
  return _validateTokenBinding.apply(this, arguments);
}

function _validateTokenBinding() {
  _validateTokenBinding = _asyncToGenerator(function* () {
...
function validateRawAuthnrData() {
  return _validateRawAuthnrData.apply(this, arguments);
}

function _validateRawAuthnrData() {
  _validateRawAuthnrData = _asyncToGenerator(function* () {
    // XXX: this isn't very useful, since this has already been parsed...
...
function validateAttestation() {
  return _validateAttestation.apply(this, arguments);
}

function _validateAttestation() {
  _validateAttestation = _asyncToGenerator(function* () {
...
function validateAssertionSignature() {
  return _validateAssertionSignature.apply(this, arguments);
}

function _validateAssertionSignature() {
  _validateAssertionSignature = _asyncToGenerator(function* () {
    var expectedSignature = this.authnrData.get("sig");
    var publicKey = this.expectations.get("publicKey");
    var rawAuthnrData = this.authnrData.get("rawAuthnrData");
    var rawClientData = this.clientData.get("rawClientDataJson"); // console.log("publicKey", publicKey);
    ...
    var clientDataHash = new Uint8Array(clientDataHashBuf).buffer; // printHex("clientDataHash", clientDataHash);
...
function validateRpIdHash() {
  return _validateRpIdHash.apply(this, arguments);
}

function _validateRpIdHash() {
  _validateRpIdHash = _asyncToGenerator(function* () {
    ...
    var domain = URL.parse(this.clientData.get("origin")).hostname;
    var createdHash = new Uint8Array(crypto.createHash("sha256").update(domain).digest()).buffer; // wouldn't it be weird if two SHA256 hashes were different lengths...?
...
function validateFlags() {
  return _validateFlags.apply(this, arguments);
}

function _validateFlags() {
  _validateFlags = _asyncToGenerator(function* () {
...
function validateInitialCounter() {
  return _validateInitialCounter.apply(this, arguments);
}

function _validateInitialCounter() {
  _validateInitialCounter = _asyncToGenerator(function* () {
    var counter = this.authnrData.get("counter"); // TODO: does counter need to be zero initially? probably not... I guess..
...
function validateAaguid() {
  return _validateAaguid.apply(this, arguments);
}

function _validateAaguid() {
  _validateAaguid = _asyncToGenerator(function* () {
...
function validateCredId() {
  return _validateCredId.apply(this, arguments);
}

function _validateCredId() {
  _validateCredId = _asyncToGenerator(function* () {
    var credId = this.authnrData.get("credId");
...
function validatePublicKey() {
  return _validatePublicKey.apply(this, arguments);
}

function _validatePublicKey() {
  _validatePublicKey = _asyncToGenerator(function* () {
    ...
    this.audit.journal.add("credentialPublicKeyJwk"); // pem
...
function validateUserHandle() {
  return _validateUserHandle.apply(this, arguments);
}

function _validateUserHandle() {
  _validateUserHandle = _asyncToGenerator(function* () {
...
function validateCounter() {
  return _validateCounter.apply(this, arguments);
}

function _validateCounter() {
  _validateCounter = _asyncToGenerator(function* () {
...
function validateAudit() {
  return _validateAudit.apply(this, arguments);
}

function _validateAudit() {
  _validateAudit = _asyncToGenerator(function* () {
